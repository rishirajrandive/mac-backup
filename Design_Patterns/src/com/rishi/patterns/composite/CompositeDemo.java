...
/**
 * Component is our base interface which states the minimum functions a primitive or composite should have
 * Primitive does not have any components
 * Composite has other composite components, thus made abstract with implementation
 * Row and Column are our composite components
 * @author rishi
 *
 */
